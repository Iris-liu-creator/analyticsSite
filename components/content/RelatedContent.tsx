...
export function RelatedProjects({ projects }: { projects: ProjectMeta[] }) {
  ...
  return (
    <section className="mt-14">
      <h2 className="text-2xl font-semibold text-ink dark:text-white">Related projects</h2>
...
export function RelatedArticles({ articles, basePath }: { articles: ArticleMeta[]; basePath: "/analysis" }) {
  ...
  return (
    <section className="mt-14">
      <h2 className="text-2xl font-semibold text-ink dark:text-white">Related reading</h2>
      <div className="mt-6 grid gap-5 md:grid-cols-3">
